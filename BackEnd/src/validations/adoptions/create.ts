...
const animalSchema = zod.object({
  userId: zod.string({
    required_error: translate({ id: "validations-adoptions-user-id-required" }),
  }),
  ongId: zod.string({
    required_error: translate({ id: "validations-adoptions-ong-id-required" }),
  }),
  animalId: zod.string({
    required_error: translate({
      id: "validations-adoptions-animal-id-required",
    }),
  }),
});
